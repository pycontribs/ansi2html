...
class TestAnsi2HTML (unittest.TestCase):
    ...
    def setUp(self):
        with open (join (_here, "ansicolor"), "rb") as input:
    ...
    def test_partial (self):
        ...
        expected = u'<span class="ansi1"><span class="ansi40"><span class="ansi31">r<span class="ansi32">a<span class="ansi33">i<span class="ansi34">n<span class="ansi35">b<span class="ansi36">o<span class="ansi37">w</span>\n'
