...
def get_styles(dark_bg=True, line_wrap=True, scheme='ansi2html'):
    css = [
        ...
        Rule('table', border_collapse='collapse'),
        Rule('.line_number', min_width='20px', padding_left='10px', padding_right='10px', text_decoration='none', 
                             text_align='right', user_select='none', vertical_align='top', white_space='nowrap', width='1%', 
